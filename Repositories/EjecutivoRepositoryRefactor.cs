...
{
    public interface IEjecutivoRepositoryRefactor
    {
    ...
    public class EjecutivoRepositoryRefactor : IEjecutivoRepositoryRefactor
    {
        ...
        public EjecutivoRepositoryRefactor(IConfiguration configuration)
        {
