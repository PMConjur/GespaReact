...
namespace NoriAPI.Repositories
{
    ...
    public class SearchRepository : ISearchRepository
    {
        ...
        public async Task<dynamic> ValidateBusqueda(string filtro, string ValorBusqueda)
        {
            ...
            switch (filtro)
            {
                case "Cuenta":
                    ...
                    queryBusqueda += " WHERE CuentaActiva = 1 AND C.idCuenta in ('340100000000000','370700000000007','371700000000002','371700000000005','376000000000001','376600000000009','376700000000000','376700000000004','370700000000004','370700000000008','376700000000007','376700000000006','376700000000008','370789338633001') AND C.idCuenta = '" + ValorBusqueda.Replace(" ", "") + "' ";
                    break;
                ...
                case "Nombre":
                    ...
                    queryBusqueda += "WHERE CuentaActiva = 1 AND C.idCuenta in ('340100000000000','370700000000007','371700000000002','371700000000005','376000000000001','376600000000009','376700000000000','376700000000004','370700000000004','370700000000008','376700000000007','376700000000006','376700000000008','370789338633001')";
                    validacion = "Nombre";
                    break;

                case "RFC":
                    queryBusqueda = queryBusqueda.Replace("Cuentas C", "Cuentas C WITH (INDEX(IX_Cuentas_RFC), NOLOCK)");
                    queryBusqueda += " WHERE CuentaActiva = 1 AND C.idCuenta in ('340100000000000','370700000000007','371700000000002','371700000000005','376000000000001','376600000000009','376700000000000','376700000000004','370700000000004','370700000000008','376700000000007','376700000000006','376700000000008','370789338633001') AND  CHARINDEX('" + ValorBusqueda.Replace(" ", "") + "', C.RFC) = 1  ";
                    break;

                case "Numero Cliente":
                    queryBusqueda = queryBusqueda.Replace("Cuentas C", "Cuentas C WITH (INDEX(IX_Cuentas_NúmeroCliente), NOLOCK)");
                    queryBusqueda += " WHERE CuentaActiva = 1 AND C.idCuenta in ('340100000000000','370700000000007','371700000000002','371700000000005','376000000000001','376600000000009','376700000000000','376700000000004','370700000000004','370700000000008','376700000000007','376700000000006','376700000000008','370789338633001') AND  C.NúmeroCliente = '" + ValorBusqueda.Replace(" ", "") + "' ";
                    break;
                ...
                case "Telefono":
                    ...
                    queryBusqueda += " WHERE CuentaActiva = 1 AND C.idCuenta in ('340100000000000','370700000000007','371700000000002','371700000000005','376000000000001','376600000000009','376700000000000','376700000000004','370700000000004','370700000000008','376700000000007','376700000000006','376700000000008','370789338633001') AND T.NúmeroTelefónico = RIGHT('" + ValorBusqueda.Replace(" ", "") + "', 10) ";
                    break;

                case "Expediente":     //El equipo Front debe validar que no tenga letras

                    queryBusqueda += " WHERE CuentaActiva = 1 AND C.idCuenta in ('340100000000000','370700000000007','371700000000002','371700000000005','376000000000001','376600000000009','376700000000000','376700000000004','370700000000004','370700000000008','376700000000007','376700000000006','376700000000008','370789338633001') AND CL.Abreviación = '";
        ...
        public async Task<List<Phone>> GetPhones(string idCuenta, int idCartera)
        {
            ...
            string phonesQuery = "SELECT * FROM [dbo].[fn_TeléfonosLadasTest](@idCartera, @idCuenta) ORDER BY Titulares DESC";
