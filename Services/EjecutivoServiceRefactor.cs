...
{
    public interface IEjecutivoServiceRefactor
    {
        Task<ResultadoProductividad> ValidateProductividad(int numEmpleado);

    }

    public class EjecutivoServiceRefactor : IEjecutivoServiceRefactor
    {
        private readonly IConfiguration _configuration;
        private readonly IEjecutivoRepositoryRefactor _ejecutivoRepository;
        ...
        public EjecutivoServiceRefactor(IConfiguration configuration, IEjecutivoRepositoryRefactor ejecutivoRepository)
        {
