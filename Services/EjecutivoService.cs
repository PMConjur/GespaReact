...
namespace NoriAPI.Services
{
	public interface IEjecutivoService
	{
		...
		Task<IEnumerable<dynamic>> ObtenerSeguimientosEjecutivoAsync(int idEjecutivo);
	...
	public class EjecutivoService : IEjecutivoService
	{
		...
		public async Task<DataTable> GetSeguimientosAsync(int idCartera, string idCuenta)
		{
			...
			string query = "SELECT * FROM fn_Seguimientos(@idCartera, @idCuenta) ORDER BY Fecha_Insert DESC, Segundo_Insert DESC";
		...
		private Dictionary<int, string> ObtenerCatalogoSeguimientos()
		{
			return new Dictionary<int, string>
	{
		...
		{ 1003, "Recado" },
		{ 1004, "Correo Enviado" },
		{ 1005, "Correo Recibido" },
		{ 1006, "Llamada Telefónica" },
		{ 1007, "Mensaje WhatsApp" },
		{ 1008, "Seguimiento Interno" },
		{ 1009, "Seguimiento Externo" },
		{ 1010, "Contacto Directo" },
		{ 1011, "Reunión Programada" },
		{ 1012, "Reunión Realizada" },
		{ 1013, "Entrega Documentos" },
		{ 1014, "Revisión Información" },
		{ 1015, "Solicitud Cliente" },
		{ 1016, "Respuesta Cliente" },
		{ 1017, "Transferencia Caso" },
		{ 1018, "Validación Datos" },
		{ 1019, "Confirmación" },
		{ 1020, "Seguimiento Proceso" },
		{ 1021, "Notificación Interna" },
		{ 1022, "Notificación Cliente" },
		{ 1023, "Espera Información" },
		{ 1024, "Llamada No Exitosa" },
		{ 1025, "Agenda Llamada" },
		{ 1026, "Casilla de Voz" },
		{ 1027, "Chat Online" },
		{ 1028, "Correo No Enviado" },
		{ 1029, "Error Envío" },
		{ 1030, "Derivado a Supervisor" },
		{ 1031, "Respuesta Pendiente" },
		{ 1032, "Caso Cerrado" },
		{ 1033, "Caso Reabierto" },
		{ 1034, "Seguimiento Especial" },
		{ 1035, "Auditoría" },
		{ 1036, "Retroalimentación" },
		{ 1037, "Espera Aprobación" },
		{ 1038, "Caso Escalado" },
		{ 1039, "Cita Agendada" },
		{ 1040, "Cita Cancelada" },
		{ 1041, "Reporte Generado" },
		{ 1042, "Reporte Entregado" },
		{ 1043, "Cliente Inubicable" },
		{ 1044, "Cliente Rechaza Atención" },
		{ 1045, "Verificación Visita" },
		{ 1046, "Verificación Teléfono" },
		{ 1047, "Atención Prioritaria" },
		{ 1048, "Actualización Sistema" },
		{ 1049, "No Requiere Seguimiento" },
		{ 1050, "Pendiente Información" },
		{ 1051, "Observación Adicional" },
		{ 1052, "Entrega de Resultados" },
		{ 1053, "Consulta Jurídica" },
		{ 1054, "Consulta Técnica" },
		{ 1055, "Pendiente Firma" },
		{ 1056, "Firma Digital" },
		{ 1057, "Archivo Caso" },
		{ 1058, "Confirmación Final" },
		{ 1059, "Notificación Final" },
		{ 1060, "Cierre Administrativo" }
	};
		}
		...
		public async Task<IEnumerable<dynamic>> ObtenerSeguimientosEjecutivoAsync(int idEjecutivo)
		{
			using (var connection = new SqlConnection(_connectionString))
			{
				...
				var seguimientos = await connection.QueryAsync<dynamic>(query, new { idEjecutivo });
